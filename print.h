...
#define print(...) _print_each(__VA_ARGS__, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0}, (_dont_print){0})
