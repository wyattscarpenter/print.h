...
int main(void) {
  ...
  //Interestingly, in my GCC, if I remove the default case of my _Generic I get error: ‘_Generic’ selector of type ‘__int128’ is not compatible with any association
  _print_unit("\n");
